...
# Outputs to docs/dashboard/index.html (separate from /implementation/ docs page)
"""
import json
import os
...
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), '..', 'docs', 'dashboard', 'index.html')
